...
SECRET_MAPPINGS: tuple[tuple[tuple[str, ...], str], ...] = (
    ...
    (("image_reference_upload", "minio_access_key"), "MINIO_ACCESS_KEY"),
    (("image_reference_upload", "minio_secret_key"), "MINIO_SECRET_KEY"),
    (("image_reference_upload", "minio_session_token"), "MINIO_SESSION_TOKEN"),
    (("image_storage", "webdav_password"), "LGWRAW_WEBDAV_PASSWORD"),
    (("image_storage", "minio_access_key"), "MINIO_ACCESS_KEY"),
    (("image_storage", "minio_secret_key"), "MINIO_SECRET_KEY"),
